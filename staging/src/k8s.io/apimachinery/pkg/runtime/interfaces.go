...
type ObjectConvertor interface {
	...
	ConvertToVersion(in Object, gv GroupVersioner) (out Object, err error)
	// ConvertFieldLabel converts the specified field label in
	// ListOptions.FieldSelector to the format of the object with the specified
	// version and kind.
	ConvertFieldLabel(version, kind, label, value string) (string, string, error)
	// ConvertDownwardAPIFieldLabel converts the specified field label (a
	// reference to a field in an object in Downward API) to the format of the
	// object with the specified version and kind.
	ConvertDownwardAPIFieldLabel(version, kind, selector, value string) (string, string, error)
}
