...
readonly master_logfiles="kube-apiserver kube-apiserver-audit kube-scheduler rescheduler tpu-scheduler kube-controller-manager etcd etcd-events glbc cluster-autoscaler kube-addon-manager fluentd"
