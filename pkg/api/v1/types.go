...
type TerminationReasonDelivery struct {
	...
	Env *string `json:"env,ommitempty" protobuf:"bytes,1,opt,name=env"`
	...
	Header *string `json:"header,ommitempty" protobuf:"bytes,2,opt,name=header"`
}
...
type PreStopHandler struct {
	...
	// reason.
	// +optional
	ReasonDelivery *TerminationReasonDelivery `json:"reasonDelivery,ommitempty" protobuf:"bytes,2,opt,name=reasonDelivery"`
}
