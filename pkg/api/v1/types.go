...
const (
	// DefaultDeleteReasonEnv is the default environment variable that will
	// be populated with the reason for a deletion.
	DefaultDeleteReasonEnv = "KUBE_DELETE_REASON"

	// DefaultDeleteReasonHeader is the default header that will be set to
	// the reason for a deletion.
...
type DeleteExecAction struct {
	ExecAction `json:",inline" protobuf:"bytes,3,opt,name=execAction"`
...
type DeleteHTTPGetAction struct {
	HTTPGetAction `json:",inline" protobuf:"bytes,7,opt,name=hTTPGetAction"`
	...
	ReasonHeader string `json:"reasonHeader,omitempty" protobuf:"bytes,6,opt,name=reasonHeader"`
}
