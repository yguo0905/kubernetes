...
func newCRIStatsProvider(cadvisor cadvisor.Interface) *statsProvider {
	return &statsProvider{
		containerStatsProvider: &criStatsProvider{},
		cadvisor:               cadvisor,
	}
}

func (provider *criStatsProvider) ListPodStats() ([]statsapi.PodStats, error) { return nil, nil }
func (provider *criStatsProvider) ImageFsInfo() (*statsapi.FsStats, error)    { return nil, nil }

type cadvisorStatsProvider struct {
	cadvisor cadvisor.Interface
}

func newCadvisorStatsProvider(cadvisor cadvisor.Interface) *statsProvider {
	return &statsProvider{
		containerStatsProvider: &cadvisorStatsProvider{cadvisor},
		cadvisor:               cadvisor,
	}
}
...
func (provider *cadvisorStatsProvider) ImageFsInfo() (*statsapi.FsStats, error) {
	...
	imageStats, err := provider.containerRuntime.ImageStats()
	if err != nil || imageStats == nil {
		return nil, fmt.Errorf("failed to get image stats: %v", err)
	}
	rootStats, err := provider.getContainerStats("/")
	if err != nil {
...
// GetCgroupStats returns the stats of the cgroup with the specified
// cgroupName.
func (kl *statsProvider) GetCgroupStats(cgroupName string) (*statsapi.ContainerStats, *statsapi.NetworkStats, error) {
	info, err := kl.getContainerInfo(cgroupName)
	if err != nil {
...
func (kl *statsProvider) RootFsInfo() (*statsapi.FsStats, error) {
	rootFsInfo, err := kl.cadvisor.RootFsInfo()
	if err != nil {
...
func (kl *statsProvider) GetContainerInfo(podFullName string, podUID types.UID, containerName string, req *cadvisorapiv1.ContainerInfoRequest) (*cadvisorapiv1.ContainerInfo, error) {
...
func (kl *statsProvider) GetRawContainerInfo(containerName string, req *cadvisorapiv1.ContainerInfoRequest, subcontainers bool) (map[string]*cadvisorapiv1.ContainerInfo, error) {
	if subcontainers {
...
func (kl *statsProvider) getContainerInfo(containerName string) (*cadvisorapiv2.ContainerInfo, error) {
...
func (kl *statsProvider) getContainerStats(containerName string) (*cadvisorapiv2.ContainerStats, error) {
